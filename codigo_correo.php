...
<main class="login-desing">
        <div class="container">
            ...
            <form action="/pagina/verificar_codigo.php"  method="POST">
                <div class="user-details">
                <div class="inputcontainer">
                    <input type="number" class="input" name="codigo" placeholder="a">
                    ...
                    <input type="hidden" class="input" name="correo" placeholder="a" value="<?php echo $correo ?>">
                     ...
                     <div class="inputcontainer">
                    <input type="hidden" class="input" name="token" placeholder="a" value="<?php echo $token ?>">
                     </div>
                </div>
