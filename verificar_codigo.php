<?php
         ...
         $res = mysqli_query ($conexion, "SELECT * FROM recu_contraseña WHERE correo='$correo' and token='$token' and codigo='$codigo'");
...
<main class="login-desing">
        <div class="container">
            <div class="titulo">Codigo Restablecer</div>
            <img class="logo" src="/pagina/img/logo_completo.jpg" alt="logo de Reparaciones Express">
            <?php
            if($correcto){
               ?>
            <form action="/pagina/php/actu_contraseña.php"  method="POST">
                <div class="user-details">
                <div class="inputcontainer">
                    <input type="text" class="input" name="contraseña" placeholder="a">
                    <label for="" class="label">password</label>
                     </div>
                     <div class="inputcontainer">
                    <input type="text" class="input" name="confirmar_contraseña" placeholder="a">
                    <label for="" class="label">confirmar password</label>
                     </div>
                     <div class="inputcontainer">
                    <input type="hidden" class="input" name="correo" placeholder="a" value="<?php echo $correo ?>">
                     </div> 
                </div>
